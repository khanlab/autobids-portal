...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "familiarity_openneuro", sa.String(length=20), nullable=False
        ),
    ...
    with op.batch_alter_table("study", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_study_submission_date"),
            ["submission_date"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["study_id"],
            ["study.id"],
            name=op.f("fk_accessible_studies_study_id_study"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["user.id"],
            name=op.f("fk_accessible_studies_user_id_user"),
        ),
        sa.PrimaryKeyConstraint(
            "user_id", "study_id", name=op.f("pk_accessible_studies")
        ),
    )
    op.create_table(
        "cfmm2tar_output",
        ...
        sa.ForeignKeyConstraint(
            ["study_id"],
            ["study.id"],
            name=op.f("fk_cfmm2tar_output_study_id_study"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_cfmm2tar_output")),
    )
    with op.batch_alter_table("cfmm2tar_output", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_cfmm2tar_output_tar_file"),
            ["tar_file"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_cfmm2tar_output_uid"), ["uid"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["cfmm2tar_output_id"],
            ["cfmm2tar_output.id"],
            name=op.f("fk_tar2bids_output_cfmm2tar_output_id_cfmm2tar_output"),
        ),
        sa.ForeignKeyConstraint(
            ["study_id"],
            ["study.id"],
            name=op.f("fk_tar2bids_output_study_id_study"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_tar2bids_output")),
    )
    with op.batch_alter_table("tar2bids_output", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_tar2bids_output_bids_dir"),
            ["bids_dir"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_tar2bids_output_heuristic"),
            ["heuristic"],
            unique=False,
        )
    ...
    with op.batch_alter_table("notification", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "payload_json", existing_type=sa.TEXT(), nullable=False
        )
        batch_op.alter_column(
    ...
    with op.batch_alter_table("task", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "complete", existing_type=sa.BOOLEAN(), nullable=False
        )
        batch_op.alter_column(
            "description", existing_type=sa.VARCHAR(length=128), nullable=False
        )
        batch_op.alter_column(
            "name", existing_type=sa.VARCHAR(length=128), nullable=False
        )
        batch_op.alter_column(
            "start_time", existing_type=sa.DATETIME(), nullable=False
        )
        batch_op.alter_column(
            "user_id", existing_type=sa.INTEGER(), nullable=False
        )
        batch_op.create_foreign_key(
            batch_op.f("fk_task_study_id_study"), "study", ["study_id"], ["id"]
        )
        batch_op.drop_column("task_button_id")

    with op.batch_alter_table("user", schema=None) as batch_op:
        batch_op.alter_column(
            "admin", existing_type=sa.BOOLEAN(), nullable=False
        )
        batch_op.alter_column(
...
def downgrade():
    ...
    with op.batch_alter_table("user", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column("other_heuristic", sa.VARCHAR(length=128), nullable=True)
        )
        batch_op.add_column(
            sa.Column(
                "selected_heuristic", sa.VARCHAR(length=128), nullable=True
            )
        )
        batch_op.add_column(
        ...
        batch_op.alter_column(
            "admin", existing_type=sa.BOOLEAN(), nullable=True
        )
    ...
    with op.batch_alter_table("task", schema=None) as batch_op:
        ...
        batch_op.drop_constraint(
            batch_op.f("fk_task_study_id_study"), type_="foreignkey"
        )
        batch_op.alter_column(
            "user_id", existing_type=sa.INTEGER(), nullable=True
        )
        batch_op.alter_column(
            "start_time", existing_type=sa.DATETIME(), nullable=True
        )
        batch_op.alter_column(
            "name", existing_type=sa.VARCHAR(length=128), nullable=True
        )
        batch_op.alter_column(
            "description", existing_type=sa.VARCHAR(length=128), nullable=True
        )
        batch_op.alter_column(
            "complete", existing_type=sa.BOOLEAN(), nullable=True
        )
    ...
    with op.batch_alter_table("notification", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "payload_json", existing_type=sa.TEXT(), nullable=True
        )
        batch_op.alter_column(
            "name", existing_type=sa.VARCHAR(length=128), nullable=True
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["user.id"], name="fk_tar2bids_user_id_user"
        ),
        sa.PrimaryKeyConstraint("id", name="pk_tar2bids"),
    )
    with op.batch_alter_table("tar2bids", schema=None) as batch_op:
        batch_op.create_index(
            "ix_tar2bids_tar_file", ["tar_file"], unique=False
        )
        batch_op.create_index(
            "ix_tar2bids_heuristic", ["heuristic"], unique=False
        )
        batch_op.create_index(
            "ix_tar2bids_bids_file", ["bids_file"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "familiarity_openneuro", sa.VARCHAR(length=20), nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["submitter_id"],
            ["submitter.id"],
            name="fk_answer_submitter_id_submitter",
        ),
        sa.PrimaryKeyConstraint("id", name="pk_answer"),
    )
    with op.batch_alter_table("answer", schema=None) as batch_op:
        batch_op.create_index(
            "ix_answer_submission_date", ["submission_date"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["user.id"], name="fk_cfmm2tar_user_id_user"
        ),
        sa.PrimaryKeyConstraint("id", name="pk_cfmm2tar"),
    )
    with op.batch_alter_table("cfmm2tar", schema=None) as batch_op:
        batch_op.create_index(
            "ix_cfmm2tar_uid_file", ["uid_file"], unique=False
        )
        batch_op.create_index(
            "ix_cfmm2tar_tar_file", ["tar_file"], unique=False
        )
