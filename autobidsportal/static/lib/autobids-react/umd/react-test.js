...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["AutobidsPortal"] = factory(require("react"));
	else
		root["AutobidsPortal"] = factory(root["React"]);
 ...
 * LICENSE file in the root directory of this source tree.
 */
__webpack_require__(5);var f=__webpack_require__(0),g=60103;exports.Fragment=60107;if("function"===typeof Symbol&&Symbol.for){var h=Symbol.for;g=h("react.element");exports.Fragment=h("react.fragment")}var m=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,n=Object.prototype.hasOwnProperty,p={key:!0,ref:!0,__self:!0,__source:!0};
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(5),r=__webpack_require__(11);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
...
__webpack_require__.d(__webpack_exports__, "TextItem", function() { return /* reexport */ Accordion_TextItem; });
__webpack_require__.d(__webpack_exports__, "DirItem", function() { return /* reexport */ Accordion_DirItem; });
__webpack_require__.d(__webpack_exports__, "genAccordion", function() { return /* reexport */ Accordion_genAccordion; });
...
// CONCATENATED MODULE: ./src/Accordion/TextItem.js
...
/* harmony default export */ var Accordion_TextItem = (TextItem);
...
function ThemeProvider({
  ...
  const contextValue = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useMemo"])(() => ({
    prefixes: { ...prefixes
    },
    breakpoints,
    dir
...
function useBootstrapPrefix(prefix, defaultPrefix) {
  const {
    prefixes
  } = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useContext"])(ThemeContext);
...
function createBootstrapComponent(Component, opts) {
  ...
  const Wrapped = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_["forwardRef"](({ ...props
  }, ref) => {
    props[forwardRefAs] = ref;
    const bsPrefix = useBootstrapPrefix(props.bsPrefix, prefix);
    return /*#__PURE__*/Object(jsx_runtime["jsx"])(Component, { ...props,
      bsPrefix: bsPrefix
    });
  });
...
const Button_Button = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_["forwardRef"](({
  ...
  return /*#__PURE__*/Object(jsx_runtime["jsx"])(Component, { ...buttonProps,
    ...props,
    ref: ref,
...
const TransitionWrapper = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  const nodeRef = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useRef"])(null);
  ...
  const handleEnter = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useCallback"])(normalize(onEnter), [onEnter]);
  const handleEntering = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useCallback"])(normalize(onEntering), [onEntering]);
  const handleEntered = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useCallback"])(normalize(onEntered), [onEntered]);
  const handleExit = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useCallback"])(normalize(onExit), [onExit]);
  const handleExiting = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useCallback"])(normalize(onExiting), [onExiting]);
  const handleExited = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useCallback"])(normalize(onExited), [onExited]);
  const handleAddEndListener = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useCallback"])(normalize(addEndListener), [addEndListener]);
...
const Collapse = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  const handleEnter = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useMemo"])(() => esm_createChainedFunction(elem => {
    elem.style[computedDimension] = '0';
  }, onEnter), [computedDimension, onEnter]);
  const handleEntering = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useMemo"])(() => esm_createChainedFunction(elem => {
    const scroll = `scroll${computedDimension[0].toUpperCase()}${computedDimension.slice(1)}`;
    elem.style[computedDimension] = `${elem[scroll]}px`;
  }, onEntering), [computedDimension, onEntering]);
  const handleEntered = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useMemo"])(() => esm_createChainedFunction(elem => {
    elem.style[computedDimension] = null;
  }, onEntered), [computedDimension, onEntered]);
  /* -- Collapsing -- */

  const handleExit = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useMemo"])(() => esm_createChainedFunction(elem => {
    elem.style[computedDimension] = `${getDimensionValue(computedDimension, elem)}px`;
    triggerBrowserReflow(elem);
  }, onExit), [onExit, getDimensionValue, computedDimension]);
  const handleExiting = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useMemo"])(() => esm_createChainedFunction(elem => {
    elem.style[computedDimension] = null;
  ...
  return /*#__PURE__*/Object(jsx_runtime["jsx"])(esm_TransitionWrapper, {
    ...
    children: (state, innerProps) => /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.cloneElement(children, { ...innerProps,
...
// CONCATENATED MODULE: ./src/Accordion/DirItem.js
...
function DirItem(props) {
  ...
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("li", {
    className: "list-group-item"
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(react_bootstrap_esm_Button, {
    ...
    "aria-expanded": open,
    variant: "link"
  }, text), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(esm_Collapse, {
    in: open
...
DirItem.propTypes = {
  text: prop_types_default.a.string.isRequired,
  children: prop_types_default.a.arrayOf(prop_types_default.a.oneOfType([prop_types_default.a.instanceOf(Accordion_TextItem), prop_types_default.a.instanceOf(DirItem)])).isRequired,
  dirId: prop_types_default.a.string.isRequired
};
/* harmony default export */ var Accordion_DirItem = (DirItem);
// CONCATENATED MODULE: ./src/Accordion/Accordion.js
...
Accordion.propTypes = {
  children: prop_types_default.a.arrayOf(prop_types_default.a.oneOfType([prop_types_default.a.instanceOf(Accordion_TextItem), prop_types_default.a.instanceOf(Accordion_DirItem)])).isRequired
};
/* harmony default export */ var Accordion_Accordion = (Accordion);
// CONCATENATED MODULE: ./src/Accordion/genAccordion.js
...
function genAccordion(fileTree) {
  var textItems = fileTree.files.map(function (fileName) {
    return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Accordion_TextItem, {
      key: fileName,
      text: fileName
    });
  });
  var dirItems = Object.entries(fileTree.dirs).map(function (_ref) {
    var key = _ref[0],
        value = _ref[1];
    return genDirItem(key, value);
  });
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Accordion_Accordion, null, textItems, dirItems);
}

function genDirItem(dirName, dirContents) {
  var textItems = dirContents.files.map(function (fileName) {
    return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Accordion_TextItem, {
      key: fileName,
      text: fileName
    });
  });
  var dirItems = Object.entries(dirContents.dirs).map(function (_ref2) {
    var key = _ref2[0],
        value = _ref2[1];
    return genDirItem(key, value);
  });
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Accordion_DirItem, {
    text: dirName,
    key: dirName,
    dirId: "dir" + dirName.replaceAll("/", "")
  }, textItems, dirItems);
}

/* harmony default export */ var Accordion_genAccordion = (genAccordion);
...
/* harmony default export */ var src = __webpack_exports__["default"] = ({
  ...
  TextItem: Accordion_TextItem,
  DirItem: Accordion_DirItem,
  genAccordion: Accordion_genAccordion
});
